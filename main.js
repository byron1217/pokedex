...
function displayPokemon(pokemon){
     console.log(pokemon)
    //console.log(pokemon.sprites.front_shiny) // verificando que la info llega
...
for (i=0;i<pokemon.moves.length;i++){
   // console.log(pokemonMoves)
    pokemonMoves = pokemonMoves + pokemon.moves[i].move.name+" ";
}
